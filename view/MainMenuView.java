...
public class MainMenuView extends JFrame {
    ...
    public MainMenuView() {
        ...
        setTitle("Quản Lý Game Rắn Săn Mồi - Nhóm 8");
        setSize(750, 500);
    ...
    private void loadDataToTable() {
        ...
        try {
         ...
         // Dùng Lambda Expression (->) và r2 so với r1 để xếp điểm số theo thứ tự giảm dần
    ...
    private void startGame() {
        ...
        if (!name.matches("^[\\p{L}\\s]+$")) {
            JOptionPane.showMessageDialog(this, "Tên chỉ được nhập chữ cái thôi nhé!", "Lỗi nhập liệu", JOptionPane.ERROR_MESSAGE);
            return; 
        }
        ...
        // CHỈNH TỐC ĐỘ TRÒ CHƠI
        int delay = difficulty.equals("Khó") ? 80 : (difficulty.equals("Trung Bình") ? 140 : 200);
        
        int levelNumber = 1; 
        if (difficulty.equals("Trung Bình")) levelNumber = 2;
        else if (difficulty.equals("Khó")) levelNumber = 3;
